...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/pranjalyadav/PycharmProjects/framework-dashboard-streamlit/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/pranjalyadav/PycharmProjects/framework-dashboard-streamlit/venv/bin/deactivate.nu'
